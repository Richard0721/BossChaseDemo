@tool
class_name FashiModel
extends Node3D

const ANIMATION_SOURCES := {
	"idle": "res://assets/characters/fashi/source/Person/Fashi Idle.fbx",
	"standing": "res://assets/characters/happy_student/source/Happy Student standing.fbx",
	"pointing": "res://assets/characters/fashi/source/Person/Fashi Pointing.fbx",
	...
	"death": "res://assets/characters/fashi/source/Person/Fashi Death From Back Headshot.fbx",
...
func _install_animation_library() -> void:
	...
	for animation_name: String in ANIMATION_SOURCES:
		...
		if source_scene == null:
			push_warning("无法载入 Fashi 动画：%s" % ANIMATION_SOURCES[animation_name])
			continue
