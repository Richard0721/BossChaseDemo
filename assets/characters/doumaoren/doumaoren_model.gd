@tool
class_name DoumaorenModel
extends Node3D

const ANIMATION_SOURCES := {
	"idle": "res://assets/characters/doumaoren/source/Person/Doumaoren Idle.fbx",
	"standing": "res://assets/characters/happy_student/source/Happy Student standing.fbx",
	"pointing": "res://assets/characters/doumaoren/source/Person/Doumaoren Pointing.fbx",
...
func _install_animation_library() -> void:
	...
	for animation_name: String in ANIMATION_SOURCES:
		...
		if source_scene == null:
			push_warning("无法载入神秘兜帽人动画：%s" % ANIMATION_SOURCES[animation_name])
			continue
